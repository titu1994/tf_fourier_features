...
# Package arguments
PACKAGE_NAME = "tf_fourier_features"
SHORT_DESCRIPION = "Tensorflow 2.0 implementation of Fourier Features mapping networks."
URL = "https://github.com/titu1994/tf_fourier_features"
LICENCE = 'MIT'
...
setup(
    name=PACKAGE_NAME,
    version=get_version(),
    packages=find_packages(exclude=['tests', 'images', 'data', 'checkpoints']),
    url=URL,
    download_url=URL,
